...
class ESqliteHelperDatabaseFMZeta(context: Context?) :
                    ...
                    1)
{
    ...
    fun crearFabricante(
        ...
        Log.i("database", "arreglo valores crear fab desde sqlite ${valoresAGuardar}")
...
//        val baseDatosLectura = this.readableDatabase
        ...
        Log.i("database", "arreglo valores crear fab desde sqlite ${arregloUsuario}")
    ...
    fun crearModelo(
        ...
        Log.i("database", "arreglo creado desde sqlite ${valoresAGuardar}")
        conexionExcritura.close()
        return if (resultadoEscritura.toInt() == -1) false else true// ==1 no se creo
    }
...
//        val baseDatosLectura = this.readableDatabase
        ...
        if (existeModelo) {
            do {
                val id = resultaConsultaLectura.getInt(0) // Columna indice 0 -> ID
                val usuarioEncontrado = EModelosBDD(id, id_fk, resultaConsultaLectura.getString(2), resultaConsultaLectura.getDouble(3), resultaConsultaLectura.getInt(4), resultaConsultaLectura.getDouble(5), resultaConsultaLectura.getString(6))
                if(id!=null){
        ...
        resultaConsultaLectura.close()
        baseDatosLectura.close()
        Log.i("database", "arreglo consulta mods desde sqlite ${arregloModelo}")
