...
class FRecyclerViewAdaptadorTiendas(private val contexto: GRecyclerViewTiendas,
                                        //private val listaRestaurantes: List<BNotifications>,
                                    private var listaTiendas: ArrayList<FirestoreTiendasDto>,
                                    private val recyclerView: RecyclerView,
                                    private val itemClickListener: OnItemClickListenerTiendas
): RecyclerView.Adapter<FRecyclerViewAdaptadorTiendas.MyViewHolder>(){
    ...
    inner class MyViewHolder(view: View): RecyclerView.ViewHolder(view) {
        ...
        init {
            ...
            logoTienda = view.findViewById<ImageView>(R.id.img_logoTienda)
        ...
        fun bind(tienda: FirestoreTiendasDto,clickListener: OnItemClickListenerTiendas)
        {
    ...
    override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
        ...
        //holder.logoTienda.setImageDrawable(tienda.image)
...
interface OnItemClickListenerTiendas{
